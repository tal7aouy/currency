...
namespace Tal7aouy\Tests;

use Tal7aouy\Currency;
use Tal7aouy\CurrencyConversion;
...
class CurrencyConversionTest extends TestCase
{
    ...
    {
        return Currency::convert($this->client)
            ->from($this->from)
            ->to($this->to)
            ->amount(1)
    ...
    {
        $this->expectException(\Tal7aouy\Exceptions\RequestException::class);
    ...
    public function amount_has_default_when_missing()
    {
        ...
        $result = Currency::convert($this->client)
                    ->from($this->from)
                    ->to($this->to)
                    ->get();
